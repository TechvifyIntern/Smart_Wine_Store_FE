...
export default function ProductDetailPage() {
  ...
  const product = discountProducts.find(
    (p) => p.DiscountProductID === productId
  );
  ...
  const isActive =
    product && !isExpired && currentDate >= new Date(product.TimeStart);
      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            The requested discount product could not be found.
          </p>
          <button
            onClick={() => router.back()}
                ...
                <div className="flex items-center gap-3 p-4 bg-white/60 dark:bg-slate-700/60 rounded-lg border border-white/80 dark:border-slate-600">
                  ...
                  <div className="flex-1">
                    ...
                    {isEditing ? (
                      ...
                      <p className="font-medium text-gray-900 dark:text-slate-100">
                        {formatDateTime(product.TimeStart)}
                      </p>
                    )}
                  </div>
                </div>
                <div className="flex items-center gap-3 p-4 bg-white/60 dark:bg-slate-700/60 rounded-lg border border-white/80 dark:border-slate-600">
                  ...
                  <div className="flex-1">
                    ...
                    {isEditing ? (
                      ...
                      <p className="font-medium text-gray-900 dark:text-slate-100">
                        {formatDateTime(product.TimeEnd)}
                      </p>
                    )}
                  </div>
                </div>
        ...
        <AlertDialogContent className="bg-white dark:bg-slate-900 border-gray-200 dark:border-slate-700">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-gray-600 dark:text-slate-400">
              Are you sure you want to save the changes to this discount
              product?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent className="bg-white dark:bg-slate-900 border-gray-200 dark:border-slate-700">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-gray-600 dark:text-slate-400">
              Are you sure you want to delete the discount product{" "}
