...
export default function EventDetailPage() {
    ...
    const isActive = event && !isExpired && currentDate >= new Date(event.TimeStart);
        ...
        return (
            <div className="flex items-center justify-center min-h-screen">
                <div className="text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-6">The requested discount event could not be found.</p>
                    <button
                        onClick={() => router.back()}
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-white/90">
                                    Detailed information for <span className="font-medium">{event.EventName}</span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-slate-800 dark:to-slate-700 rounded-xl p-6 border border-blue-100 dark:border-slate-600">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="flex items-center gap-3 p-4 bg-white/60 dark:bg-slate-700/60 rounded-lg border border-white/80 dark:border-slate-600">
                                    ...
                                    <div>
                                        <p className="text-xs text-gray-500 dark:text-slate-400 uppercase tracking-wide">Event ID</p>
                                        <p className="font-medium text-gray-900 dark:text-slate-100">#{event.DiscountEventID}</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 p-4 bg-white/60 dark:bg-slate-700/60 rounded-lg border border-white/80 dark:border-slate-600">
                                    <div className="w-8 h-8 bg-blue-100 dark:bg-blue-900/50 rounded-full flex items-center justify-center">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-xs text-gray-500 dark:text-slate-400 uppercase tracking-wide">Event Name</p>
                                        {isEditing ? (
                                            <div>
                                                <Input
                                                    {...register("EventName")}
                                            ...
                                            <p className="font-medium text-gray-900 dark:text-slate-100">{event.EventName}</p>
                                        )}
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 p-4 bg-white/60 dark:bg-slate-700/60 rounded-lg border border-white/80 dark:border-slate-600 md:col-span-2">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        {isEditing ? (
                                            ...
                                            <p className="font-medium text-gray-900 dark:text-slate-100">{event.Description || "No description provided"}</p>
                                        )}
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="flex items-center gap-3 p-4 bg-white/60 dark:bg-slate-700/60 rounded-lg border border-white/80 dark:border-slate-600">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        {isEditing ? (
                                            ...
                                            <p className="font-bold text-orange-600 dark:text-orange-400 text-lg">{event.DiscountValue}%</p>
                                        )}
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 p-4 bg-white/60 dark:bg-slate-700/60 rounded-lg border border-white/80 dark:border-slate-600">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        {isEditing ? (
                                            ...
                                            <p className="font-medium text-gray-900 dark:text-slate-100">{formatDateTime(event.TimeStart)}</p>
                                        )}
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 p-4 bg-white/60 dark:bg-slate-700/60 rounded-lg border border-white/80 dark:border-slate-600">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        {isEditing ? (
                                            ...
                                            <p className="font-medium text-gray-900 dark:text-slate-100">{formatDateTime(event.TimeEnd)}</p>
                                        )}
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 p-4 bg-white/60 dark:bg-slate-700/60 rounded-lg border border-white/80 dark:border-slate-600">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="flex items-center gap-3 p-4 bg-white/60 dark:bg-slate-700/60 rounded-lg border border-white/80 dark:border-slate-600">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium text-gray-900 dark:text-slate-100">{formatDateTime(event.CreatedAt)}</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 p-4 bg-white/60 dark:bg-slate-700/60 rounded-lg border border-white/80 dark:border-slate-600">
                                    <div className="w-8 h-8 bg-indigo-100 dark:bg-indigo-900/50 rounded-full flex items-center justify-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium text-gray-900 dark:text-slate-100">{event.UpdatedAt ? formatDateTime(event.UpdatedAt) : formatDateTime(event.CreatedAt)}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
