...
export default function OrderDetailPage() {
    ...
    const handleExportPDF = () => {
        ...
        doc.text(`Order Date: ${new Date(order.CreatedAt).toLocaleDateString()}`, 20, 100);
        ...
        if (order.Details && order.Details.length > 0) {
            order.Details.forEach((detail, index) => {
                ...
                doc.text(`Quantity: ${detail.Quantity} × $${detail.UnitPrice.toFixed(2)} = $${detail.FinalItemPrice.toFixed(2)}`, 30, yPosition + 8);
                yPosition += 20;
            });
        }
                        ...
                        <div>
                            ...
                            <div className="mt-2 space-y-2">
                                {order.Details.map((detail, index) => (
                                    <div key={detail.DetailID} className="p-3 bg-gray-50 dark:bg-gray-700 rounded">
                                        <div className="flex justify-between items-start">
                                            ...
                                            <p className="font-semibold">${detail.FinalItemPrice.toFixed(2)}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
