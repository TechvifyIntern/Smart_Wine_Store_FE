...
export const createAccountSchema = z
  .object({
    ...
    PhoneNumber: z
      ...
      .regex(
        /^(09|03)\d{8}$/,
        "Phone number must be valid Vietnamese format (09xxxxxxxx or 03xxxxxxxx)"
      ),
    Birthday: z
      .string()
      ...
      .refine((val) => {
        ...
        if (age === 18 && (monthDiff > 0 || (monthDiff === 0 && dayDiff >= 0)))
          return true;
        return false;
      }, "You must be at least 18 years old"),
    RoleID: z.number().min(1, "Role is required"),
    TierID: z.number().min(1, "Tier is required"),
    Password: z
      .string()
