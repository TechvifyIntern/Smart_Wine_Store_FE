...
export function CreateProductModal({
  ...
  const onSubmit = async (data: CreateProductFormData) => {
    try {
      ...
      if (data.detail) {
        const hasDetailData = Object.values(data.detail).some(
              ...
              <div className="space-y-4 border-t pt-4 mt-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    {errors.detail?.Producer && (
                      <p className="text-sm text-red-500">
                        {errors.detail.Producer.message}
                      </p>
                    )}
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  {errors.detail?.Varietal && (
                    <p className="text-sm text-red-500">
                      {errors.detail.Varietal.message}
                    </p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  <Label
                    htmlFor="detail.DescriptionTitle"
                    className="text-sm font-medium text-gray-900!"
                  >
                    Description Title
                  </Label>
                  ...
                  {errors.detail?.DescriptionTitle && (
                    <p className="text-sm text-red-500">
                      {errors.detail.DescriptionTitle.message}
                    </p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  <Label
                    htmlFor="detail.DescriptionContents"
                    className="text-sm font-medium text-gray-900!"
                  >
                    Description
                  </Label>
                  ...
                  {errors.detail?.DescriptionContents && (
                    <p className="text-sm text-red-500">
                      {errors.detail.DescriptionContents.message}
                    </p>
                  )}
                </div>
              </div>
