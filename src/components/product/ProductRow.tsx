...
interface ProductRowProps {
    ...
    onStatusChangePending: (id: number) => void;
}
        ...
        >
            ...
            <td className="px-6 py-4 whitespace-nowrap">
                <div onClick={(e) => e.stopPropagation()}>
                    ...
                    >
                        <SelectTrigger className={`w-[110px] h-7 text-xs font-medium border-0 ${getStatusBadgeColor(product.isActive)}`}>
                            <SelectValue />
                        </SelectTrigger>
                        <SelectContent className="dark:bg-slate-800 dark:border-slate-700">
                            <SelectItem value="active" className="text-xs dark:text-slate-200 dark:focus:bg-slate-700">
                                Active
                            </SelectItem>
                            <SelectItem value="inactive" className="text-xs dark:text-slate-200 dark:focus:bg-slate-700">
                                Inactive
                            </SelectItem>
                        </SelectContent>
                    </Select>
