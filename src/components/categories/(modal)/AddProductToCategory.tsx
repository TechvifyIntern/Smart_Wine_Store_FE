...
export function AddProductToCategory({
    ...
    // Get available products (not in current category and active)
    const availableProducts = useMemo(() => {
        return products.filter(product =>
            !currentProducts.some(cp => cp.ProductID === product.ProductID) &&
            ...
            <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-hidden bg-white! border-gray-200!">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-gray-600!">
                        Chọn sản phẩm để thêm vào danh mục <strong className="text-gray-900">{categoryName}</strong>
                    </DialogDescription>
                </DialogHeader>
                                    ...
                                    >
                                        <Checkbox
                                            ...
                                            onCheckedChange={(checked) =>
                                                handleProductToggle(product.ProductID, checked as boolean)
                                            }
                                        />
                ...
                <DialogFooter className="gap-2 sm:gap-2">
                    ...
                    >
                        Thêm {selectedProductIds.size > 0 ? `(${selectedProductIds.size})` : ""} sản phẩm
                    </Button>
                </DialogFooter>
            </DialogContent>
        </Dialog>
