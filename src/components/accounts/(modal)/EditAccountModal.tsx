...
export default function EditAccountModal({
  ...
  const handleResetPassword = async () => {
    ...
    try {
      const response = await userManagementRepository.sendPasswordReset(
        account.UserID,
        account.Email
      );
      ...
      if (response.success) {
        toast({
          ...
          description: `Password reset link has been sent to ${account.Email}`,
        });
      } else {
        toast({
          title: "Reset failed",
          description: `Failed to send password reset: ${response.message}`,
          variant: "destructive",
        });
      }
    } catch (error) {
      ...
      toast({
        title: "Reset failed",
        description: "Failed to send password reset due to an error.",
        variant: "destructive",
      });
    }
  };
